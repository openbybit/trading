...
// EvalSha redis lua eval func
func EvalSha(ctx context.Context, rdb *redis.Redis, script *redis.Script, keys []string, args ...interface{}) (interface{}, error) {
	return rdb.ScriptRunCtx(ctx, script, keys, args...)
}
